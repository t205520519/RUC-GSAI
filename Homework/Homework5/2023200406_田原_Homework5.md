...
```assembly
Movsbl	12(%ebp), %edx	#说明12(%ebp)处为1字节的参数
...
(1) Instruction 1: %ebp = 0x7FFFFFF4 %esp = 0x7FFFFFC0

(2) Instruction 2: %ebp = 0x7FFFFFC0 %esp = 0x7FFFFFC0

(3) Instruction 3: %ebp = 0x7FFFFFF4 %esp = 0x7FFFFFC4
